...
- マージ後の確認と後処理を行う.
    ...
    - Issue の `進捗` を `完了` に更新する. `bash ${CLAUDE_SKILL_DIR}/scripts/update_issue_body.sh <issue番号> <body_file>` を使う.
