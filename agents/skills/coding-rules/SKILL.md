...
この skill は, このリポジトリーで作業するターン全体に適用します.
実装, 調査, 返答のいずれでも, 本 skill の参照規則を確認して進めてください.
...
C++ コードを変更するターンでは `cpp_coding_rule.md` を, Rust コードを変更するターンでは `rust_coding_rule.md` を適用してください.
