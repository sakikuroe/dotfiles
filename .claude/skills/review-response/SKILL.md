...
- [reply_comment.sh](./scripts/reply_comment.sh): `bash .claude/skills/review-response/scripts/reply_comment.sh <PR番号> <comment_id> <body_file>` で、通常の PR コメントへ引用付きで返答する。
