---
name: implementation
description: 計画に沿った実装を担うスキル. 作業用 worktree で実装, 検証, コミットを行うときに使用する. 単独で実装・コミットを行う場面でも使用する.
---
...
- [git-commit](../git-commit/SKILL.md): コミットの作法を定める. コミットは git-commit スキルの `commit_with_signature.sh` で行う.
